...
export const DropIcon = ({ width = '1.2rem', height = '1.2rem', className }) => (
...
export const LoadingIcon = ({ width = '4.6rem', height = '4.6rem', className }) => (
